      ...
      <div className="p-6 space-y-8">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild>
              <Link href="/games" data-testid="button-browse-games">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <Button variant="ghost" asChild size="sm">
            <Link href="/games" data-testid="link-view-all-games">
              View All
              <ArrowRight className="ml-1 h-4 w-4" />
            </Link>
          </Button>
        </div>
        <GameGrid games={featuredGames} isLoading={isLoading} onGameClick={handleGameClick} />
      </section>
