...
export function GameCard({ game, onClick }: GameCardProps) {
  ...
  return (
    <button
      ...
      data-testid={`title-card-${game.id}`}
    >
      <img
        src={thumbnailUrl}
        alt={game.title}
        ...
        onError={(e) => {
          ...
          target.src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="400" height="300" viewBox="0 0 400 300"><rect fill="%23333" width="400" height="300"/><text fill="%23666" font-size="20" x="50%" y="50%" text-anchor="middle" dy=".3em">Image</text></svg>';
        }}
      />
  ...
  if (games.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 className="font-heading font-medium text-lg mb-1">No titles found</h3>
